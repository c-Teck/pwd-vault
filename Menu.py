...
import subprocess
from database_manager import store_passwords, find_users, find_password, password_gen,update_details
...
def create():
   ...
   app_name = input()
   print('[+]Please provide a simple password for this site or leave empty to generate a secured password for you :')
   if input() != "" :
       plaintext = input()
    else :
        plain_text = password_gen(8)
